...
export const slides: SlideModule['slides'] = [
  ...
  { id: 'resource-account', render: (props) => <ResourceAccountSlide {...props} /> },
  { id: 'not-a-failure', render: (props) => <NotAFailureSlide {...props} /> },
  { id: 'section-mfa', render: (props) => <SectionMfaSlide {...props} /> },
  { id: 'dont-mfa', render: (props) => <DontMfaSlide {...props} /> },
  { id: 'also-block', render: (props) => <AlsoBlockSlide {...props} /> },
  { id: 'section-how', render: (props) => <SectionHowSlide {...props} /> },
  { id: 'two-factors', render: (props) => <TwoFactorsSlide {...props} /> },
  { id: 'example-policy', render: (props) => <ExamplePolicySlide {...props} /> },
  { id: 'separate-policy', render: (props) => <SeparatePolicySlide {...props} /> },
  { id: 'intune-required', render: (props) => <IntuneRequiredSlide {...props} /> },
  { id: 'section-flows', render: (props) => <SectionFlowsSlide {...props} /> },
  { id: 'ropc', render: (props) => <RopcSlide {...props} /> },
  { id: 'mtr-uses-ropc', render: (props) => <MtrUsesRopcSlide {...props} /> },
  { id: 'device-code', render: (props) => <DeviceCodeSlide {...props} /> },
  { id: 'exception-scope', render: (props) => <ExceptionScopeSlide {...props} /> },
  { id: 'exception-design', render: (props) => <ExceptionDesignSlide {...props} /> },
  { id: 'report-only-trap', render: (props) => <ReportOnlyTrapSlide {...props} /> },
  { id: 'section-next', render: (props) => <SectionNextSlide {...props} /> },
  { id: 'remaining-risk', render: (props) => <RemainingRiskSlide {...props} /> },
  { id: 'passwordless', render: (props) => <PasswordlessSlide {...props} /> },
  { id: 'passwordless-caveats', render: (props) => <PasswordlessCaveatsSlide {...props} /> },
  { id: 'recap', render: (props) => <RecapSlide {...props} /> },
  { id: 'related-decks', render: (props) => <RelatedDecksSlide {...props} /> },
