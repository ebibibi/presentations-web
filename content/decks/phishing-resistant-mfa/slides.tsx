...
export const slides: SlideModule['slides'] = [
  ...
  { id: 'section-kinds', render: (props) => <SectionKindsSlide {...props} /> },
  { id: 'not-one-thing', render: (props) => <NotOneThingSlide {...props} /> },
  { id: 'methods', render: (props) => <MethodsSlide {...props} /> },
  { id: 'strengths', render: (props) => <StrengthsSlide {...props} /> },
  { id: 'guests', render: (props) => <GuestsSlide {...props} /> },
  { id: 'guest-methods', render: (props) => <GuestMethodsSlide {...props} /> },
  { id: 'section-what', render: (props) => <SectionWhatSlide {...props} /> },
  { id: 'definition', render: (props) => <DefinitionSlide {...props} /> },
  { id: 'handoff', render: (props) => <HandoffSlide {...props} /> },
  { id: 'section-why', render: (props) => <SectionWhySlide {...props} /> },
  { id: 'premise', render: (props) => <PremiseSlide {...props} /> },
  { id: 'proxy', render: (props) => <ProxySlide {...props} /> },
  { id: 'aitm-flow', render: (props) => <AitmFlowSlide {...props} /> },
  { id: 'number-matching', render: (props) => <NumberMatchingSlide {...props} /> },
  { id: 'prize', render: (props) => <PrizeSlide {...props} /> },
  { id: 'what-loses', render: (props) => <WhatLosesSlide {...props} /> },
  { id: 'section-fido', render: (props) => <SectionFidoSlide {...props} /> },
  { id: 'why-fido', render: (props) => <WhyFidoSlide {...props} /> },
  { id: 'the-three', render: (props) => <TheThreeSlide {...props} /> },
  { id: 'caveats', render: (props) => <CaveatsSlide {...props} /> },
  { id: 'not-silver-bullet', render: (props) => <NotSilverBulletSlide {...props} /> },
  { id: 'shared-devices', render: (props) => <SharedDevicesSlide {...props} /> },
  { id: 'how-to-start', render: (props) => <HowToStartSlide {...props} /> },
