...
export const slides: SlideModule['slides'] = [
  ...
  { id: 'the-scene', render: (props) => <TheSceneSlide {...props} /> },
  { id: 'the-wall', render: (props) => <TheWallSlide {...props} /> },
  { id: 'exclusion-trap', render: (props) => <ExclusionTrapSlide {...props} /> },
  { id: 'what-is-service-id', render: (props) => <WhatIsServiceIdSlide {...props} /> },
  { id: 'ideal-state', render: (props) => <IdealStateSlide {...props} /> },
  { id: 'real-target', render: (props) => <RealTargetSlide {...props} /> },
  { id: 'which-org', render: (props) => <WhichOrgSlide {...props} /> },
  { id: 'section-inventory', render: (props) => <SectionInventorySlide {...props} /> },
  { id: 'inventory-logs', render: (props) => <InventoryLogsSlide {...props} /> },
  { id: 'sort-by-log', render: (props) => <SortByLogSlide {...props} /> },
  { id: 'logs-blindspots', render: (props) => <LogsBlindspotsSlide {...props} /> },
  { id: 'retention', render: (props) => <RetentionSlide {...props} /> },
  { id: 'ledger', render: (props) => <LedgerSlide {...props} /> },
  { id: 'ledger-human-part', render: (props) => <LedgerHumanPartSlide {...props} /> },
  { id: 'section-destination', render: (props) => <SectionDestinationSlide {...props} /> },
  { id: 'classify', render: (props) => <ClassifySlide {...props} /> },
  { id: 'not-by-name', render: (props) => <NotByNameSlide {...props} /> },
  { id: 'managed-identity', render: (props) => <ManagedIdentitySlide {...props} /> },
  { id: 'arc', render: (props) => <ArcSlide {...props} /> },
  { id: 'mi-not-silver-bullet', render: (props) => <MiNotSilverBulletSlide {...props} /> },
  { id: 'wif', render: (props) => <WifSlide {...props} /> },
  { id: 'uami-vs-app', render: (props) => <UamiVsAppSlide {...props} /> },
  { id: 'wif-guardrails', render: (props) => <WifGuardrailsSlide {...props} /> },
  { id: 'rollout', render: (props) => <RolloutSlide {...props} /> },
  { id: 'microsoft-mfa', render: (props) => <MicrosoftMfaSlide {...props} /> },
  { id: 'recap', render: (props) => <RecapSlide {...props} /> },
  { id: 'next-decks', render: (props) => <NextDecksSlide {...props} /> },
  { id: 'related-videos', render: (props) => <RelatedVideosSlide {...props} /> },
  { id: 'ebistudy', render: (props) => <EbiStudySlide {...props} /> },
