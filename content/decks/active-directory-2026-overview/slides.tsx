...
export const slides: SlideModule['slides'] = [
  ...
  { id: 'goal', render: () => <GoalSlide /> },
  { id: 'original-map', render: () => <OriginalMapSlide /> },
  { id: 'structure', render: () => <StructureSlide /> },
  { id: 'ad-and-dns-history', render: () => <AdAndDnsHistorySlide /> },
  { id: 'forest-domain', render: () => <ForestDomainSlide /> },
  { id: 'forest-patterns', render: () => <ForestPatternsSlide /> },
  { id: 'site', render: () => <SiteSlide /> },
  { id: 'site-link', render: () => <SiteLinkSlide /> },
  { id: 'container-ou', render: () => <ContainerOuSlide /> },
  { id: 'ad-integrated-dns', render: () => <AdIntegratedDnsSlide /> },
  { id: 'srv-record', render: () => <SrvSlide /> },
  { id: 'directory-service', render: () => <DirectoryServiceSlide /> },
  { id: 'ldap', render: () => <LdapSlide /> },
  { id: 'authentication', render: () => <AuthenticationSlide /> },
  { id: 'group-policy', render: () => <GpoSlide /> },
  { id: 'domain-join', render: () => <DomainJoinSlide /> },
  { id: 'user-profile', render: () => <UserProfileSlide /> },
  { id: 'database-partitions', render: () => <DatabasePartitionsSlide /> },
  { id: 'global-catalog', render: () => <GlobalCatalogSlide /> },
  { id: 'replication', render: () => <ReplicationSlide /> },
  { id: 'tombstone', render: () => <TombstoneSlide /> },
  { id: 'schema', render: () => <SchemaSlide /> },
  { id: 'fsmo', render: () => <FsmoSlide /> },
  { id: 'sysvol', render: () => <SysvolSlide /> },
  { id: 'trust', render: () => <TrustSlide /> },
  { id: 'recovery', render: () => <RecoverySlide /> },
  { id: 'diagnostics', render: () => <DiagnosticsSlide /> },
  { id: 'changes-2026', render: () => <Changes2026Slide /> },
