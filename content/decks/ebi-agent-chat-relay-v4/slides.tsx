...
export const slides: SlideModule['slides'] = [
  ...
  { id: 'entrance-only', render: props => <EntranceOnlySlide {...props} /> },
  { id: 'two-axes', render: props => <TwoAxesSlide {...props} /> },
  { id: 'why-teams-hard', render: props => <WhyTeamsHardSlide {...props} /> },
  { id: 'no-public-agent-host', render: props => <NoPublicAgentHostSlide {...props} /> },
  { id: 'outbound-flow', render: props => <OutboundFlowSlide {...props} /> },
  { id: 'combinations', render: props => <CombinationsSlide {...props} /> },
  { id: 'setup-eight', render: props => <SetupEightSlide {...props} /> },
  { id: 'data-boundary', render: props => <DataBoundarySlide {...props} /> },
  { id: 'agui', render: props => <AguiSlide {...props} /> },
