...
export const slides: SlideModule['slides'] = [
  ...
  { id: 'made-an-app', render: (props) => <MadeAnAppSlide {...props} /> },
  { id: 'sudden-wall', render: (props) => <SuddenWallSlide {...props} /> },
  { id: 'already-have-id', render: (props) => <AlreadyHaveIdSlide {...props} /> },
  { id: 'first-party-apps', render: (props) => <FirstPartyAppsSlide {...props} /> },
  { id: 'why-id', render: (props) => <WhyIdSlide {...props} /> },
  { id: 'why-not-my-id', render: (props) => <WhyNotMyIdSlide {...props} /> },
  { id: 'two-identities', render: (props) => <TwoIdentitiesSlide {...props} /> },
  { id: 'registration', render: (props) => <RegistrationSlide {...props} /> },
  { id: 'api-analogy', render: (props) => <ApiAnalogySlide {...props} /> },
  { id: 'm365-city', render: (props) => <M365CitySlide {...props} /> },
  { id: 'graph', render: (props) => <GraphSlide {...props} /> },
  { id: 'complete-flow', render: (props) => <CompleteFlowSlide {...props} /> },
  { id: 'token', render: (props) => <TokenSlide {...props} /> },
  { id: 'two-token-paths', render: (props) => <TwoTokenPathsSlide {...props} /> },
  { id: 'delegated', render: (props) => <DelegatedSlide {...props} /> },
  { id: 'app-only', render: (props) => <AppOnlySlide {...props} /> },
  { id: 'permission', render: (props) => <PermissionSlide {...props} /> },
  { id: 'consent', render: (props) => <ConsentSlide {...props} /> },
  { id: 'registration-policy', render: (props) => <RegistrationPolicySlide {...props} /> },
  { id: 'it-creates', render: (props) => <ItCreatesSlide {...props} /> },
  { id: 'credential-safety', render: (props) => <CredentialSafetySlide {...props} /> },
  { id: 'admin-view', render: (props) => <AdminViewSlide {...props} /> },
  { id: 'request-example', render: (props) => <RequestExampleSlide {...props} /> },
  { id: 'recap', render: (props) => <RecapSlide {...props} /> },
  { id: 'end-summary', render: (props) => <EndSummarySlide {...props} /> },
  { id: 'ebistudy', render: (props) => <EbiStudySlide {...props} /> },
  { id: 'sources', render: (props) => <SourcesSlide {...props} /> },
  { id: 'sources-operations', render: (props) => <SourcesOperationsSlide {...props} /> },
