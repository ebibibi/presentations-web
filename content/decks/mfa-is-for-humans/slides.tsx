...
export const slides: SlideModule['slides'] = [
  ...
  { id: 'section-factor', render: (props) => <SectionFactorSlide {...props} /> },
  { id: 'factor-is-category', render: (props) => <FactorIsCategorySlide {...props} /> },
  { id: 'three-categories', render: (props) => <ThreeCategoriesSlide {...props} /> },
  { id: 'password-pin', render: (props) => <PasswordPinSlide {...props} /> },
  { id: 'definition', render: (props) => <DefinitionSlide {...props} /> },
  { id: 'section-count', render: (props) => <SectionCountSlide {...props} /> },
  { id: 'whfb-feels-like-one', render: (props) => <WhfbFeelsLikeOneSlide {...props} /> },
  { id: 'whfb-inside', render: (props) => <WhfbInsideSlide {...props} /> },
  { id: 'sms-vs-whfb', render: (props) => <SmsVsWhfbSlide {...props} /> },
  { id: 'modern-design', render: (props) => <ModernDesignSlide {...props} /> },
  { id: 'section-system', render: (props) => <SectionSystemSlide {...props} /> },
  { id: 'official-line', render: (props) => <OfficialLineSlide {...props} /> },
  { id: 'no-hands', render: (props) => <NoHandsSlide {...props} /> },
  { id: 'cert-plus-secret', render: (props) => <CertPlusSecretSlide {...props} /> },
  { id: 'trust-boundary', render: (props) => <TrustBoundarySlide {...props} /> },
  { id: 'what-matters', render: (props) => <WhatMattersSlide {...props} /> },
  { id: 'preference-order', render: (props) => <PreferenceOrderSlide {...props} /> },
  { id: 'ca-still-applies', render: (props) => <CaStillAppliesSlide {...props} /> },
  { id: 'naming', render: (props) => <NamingSlide {...props} /> },
  ...
  { id: 'ebi-study', render: (props) => <EbiStudySlide {...props} /> },
