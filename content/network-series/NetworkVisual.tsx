    ...
    <Slide className="net-slide">
      ...
      <DiagramFrame frame={frame} caption={caption} note={note}>
        <svg className="net-diagram" viewBox="0 0 1120 550" role="img" aria-label={caption}>
          ...
          {mode === 'nat' ? <g><Tag x={40} y={190} text="送信元：192.168.1.10" color="#72d8ff" opacity={linear(frame, 15, 35)} /><Tag x={620} y={145} text="外では：198.51.100.20" color="#ffbd6a" opacity={linear(frame, 56, 78)} /><Tag x={650} y={435} text="戻りは元のPCへ" color="#ffbd6a" opacity={linear(frame, 94, 116)} /></g> : null}
